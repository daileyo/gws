...
- [Commands Reference](commands.md) — All flags and commands with examples and output samples
- [Shell Integration](shell-integration.md) — Set up the `gws` shell function and workspace navigation aliases
